...
/**
 * Generated class for the Efectividad page.
 *
...
@IonicPage()
@Component({
  selector: 'page-efectividad',
  templateUrl: 'efectividad.html',
})
export class Efectividad {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad Efectividad');
  }
         ...
         if( this.perfilUsuario != undefined || this.perfilUsuario != null ){
             ...
             const subject = new Subject(); // import {Subject} from 'rxjs/Subject';
              ...
              queryObservable.subscribe(queriedItems => {
                ...
                this.datosEfectividad = queriedItems;
              });
